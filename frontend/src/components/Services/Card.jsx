...
function Card({ card }) {
  return (
    <div className="transition-all ease-in-out hover:scale-105 duration-500 flex flex-col items-center gap-y-8 px-11 py-8 w-[23rem] h-[23rem] rounded-[6.25rem] gradient-border relative cursor-pointer">
