...
function TechStackCard({ card }) {
  return (
    <div className="bg-[#FFFFFF82] w-full border-2 border-white drop-shadow-sm shadow-md rounded-3xl p-8 flex flex-col gap-y-4 md:flex-row justify-center items-center gap-x-8">
