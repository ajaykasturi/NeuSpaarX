...
function AboutUs() {
  return (
    <div className="flex gap-x-24 justify-between mx-[5vw] my-28 max-[1050px]:flex-col max-[1050px]:gap-y-10 max-[1050px]:items-center items-center">
      ...
      <div className="flex flex-col items-start justify-center gap-y-6 max-[1050px]:items-center">
        <div className="font-Poppins text-5xl font-normal max-[500px]:text-4xl">
          About Us
        </div>
        <div className="text-justify text-wrap text-base">
        ...
        <Link
          to={"/about"}
          className="rounded-full py-3 px-5 cursor-pointer hover:opacity-90  bg-companycolor text-white text-[1rem]"
        >
          Know More
        </Link>
      </div>
