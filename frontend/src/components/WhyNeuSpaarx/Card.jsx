...
function Card({ card }) {
  return (
    ...
    //   </div>
    // </div>
    <div className="bg-[#FFFFFF82] transition-all hover:scale-[1.03] duration-500 flex flex-col shrink-0 gap-y-8 items-center p-9 max-w-[18rem] w-full h-[20rem] border-2 gradient-border border-slate-50 shadow-sm rounded-3xl relative">
